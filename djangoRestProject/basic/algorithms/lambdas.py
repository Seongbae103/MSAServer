...
last_names = ["김", "이", "박", "최", "정", "강", "조", "윤", "장", "임", "한", "오", "서", "신", "권", "황", "안", "송", "류",
               ...
               "어", "은", "편", "구", "용"]
first_words = ["가", "강", "건", "경", "고", "관", "광", "구", "규", "근", "기", "길", "나", "남", "노", "누", "다","단", "달",
...
lambda_k_name = lambda k: ''.join(random.sample(last_names, k-1))+''.join(random.sample(first_words, k))
